      ...
      <section class="text-gray-600 body-font relative">
        <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            ...
            <div class="bg-black relative flex flex-wrap py-6 rounded shadow-md">
              <div class="lg:w-1/2 px-6">
                <h2 class="title-font font-semibold text-blue-600 tracking-widest text-xs">LEARN PLUS</h2>
                <p class="mt-1 text-white">Es una aplicancion educactiva</p>
              </div>
              <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                ...
                <h2 class="title-font font-semibold text-white  tracking-widest text-xs mt-4">CEL</h2>
                <p class="leading-relaxed text-blue-300">(+503)8869-2002</p>
              </div>
            </div>
          </div>
          <form onSubmit={handleContacto} class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            ...
            <button class="text-white bg-blue-900 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg">enviar</button>
          </form>
        </div>
      </section>
